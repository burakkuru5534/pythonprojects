# Ders Notu Hesaplama #
# Kaç vize kaç ödev olduğunu sor. Yüzdelerini sor. Vize ödev ve Final notlarını
#sor. Ders notunu hesapla. Hangi harf notuna karşılık geldiğini belirle. yazdır.

from __future__ import division # bölme işlmlerinin tam sonuç vermesi için
